...
-- 1. Lock down SECURITY DEFINER email queue functions
...
-- 3. Remove permissive "always true" insert policy on estimate_requests.
-- Submissions now flow through the server route using service_role, which bypasses RLS.
